...
export default function Home() {
  ...
  if (marketState.isSuccess){
    ...
    marketStateFinal = {marketStatus : +marketStateData[0].lastPrice > +marketStateData[1].lastPrice ? 'bullish' : 'bearish' , totalBalance : +marketStateData[0].totalBalance , activeCurrencies : marketStateData[0].currencies , priceChange : (((+marketStateData[0].totalBalance)-(+marketStateData[marketStateData.length-1].totalBalance))/(+marketStateData[marketStateData.length-1].totalBalance))*100}
